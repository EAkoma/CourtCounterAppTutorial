...
public class MainActivity extends AppCompatActivity {
    ...
    public void printToLogs(View view) {
        ...
        TextView textView2 = (TextView) findViewById(R.id.menu_item_1);
        String menuItem2 = textView1.getText().toString();
        Log.v("MainActivity", menuItem2);

        // Find third menu item TextView and print the text to the logs
        TextView textView3 = (TextView) findViewById(R.id.menu_item_1);
        String menuItem3 = textView1.getText().toString();
